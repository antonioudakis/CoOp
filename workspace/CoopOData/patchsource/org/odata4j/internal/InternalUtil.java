...
/**
 * Patched by Liossis.
 * The Restlet client has a bug consuming dates that only include minutes, not seconds. 
 * The original odata4j server does not include seconds in the XML representation if they are zero, 
 * triggering the bug to the client.
 * This patch forces inclusion of seconds at all times in XML output.
 */
