...
//      .findEdmProperty(prop));
        ...
        /* Liossis: End of code replacement. */
    ...
    /* Liossis: Start of 'expand' support, with added eager loading of expanded relationships. */
    ...
    if (!isCount && context.getQueryInfo().expand != null)
    {
    	...
    	{
    		//jpql += String.format(" LEFT JOIN FETCH %s.%s", alias, expandProperty.getPropertyName().replace('/', '.'));
    ...
    /* Liossis: End of 'expand' support, with added eager loading of expanded relationships. */
